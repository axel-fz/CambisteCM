...
export default async function DashboardPage() {
  ...
  return (
    <div className="relative min-h-screen space-y-6 pb-10 md:space-y-10">
      {/* Background Decor */}
      ...
      {/* ─── Hero Header ───────────────────────────────────────────────── */}
      <header className="relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-6 shadow-xl backdrop-blur-xl md:rounded-[2rem] md:p-10">
        <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-6">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-slate-900 md:mt-4 md:text-5xl">
              Tableau de bord
            </h1>
            <p className="mt-3 max-w-xl text-base font-medium text-slate-500/80 leading-relaxed md:mt-4 md:text-lg">
              {role === "echangeur"
      ...
      <div className="space-y-6 md:space-y-10">
        <section className="group relative overflow-hidden rounded-2xl border border-white/40 bg-white/60 p-1 shadow-2xl backdrop-blur-2xl md:rounded-[2.5rem]">
